...
func handleGeoadd(arr []string) string {
	if len(arr) < 5 {
...
func handleGeopos(arr []string) string {
	if len(arr) < 3 {
...
func handleGeodist(arr []string) string {
	if len(arr) < 4 {
...
func handleGeosearch(arr []string) string {
	if len(arr) < 8 {
